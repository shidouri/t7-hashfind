...
function function_30d4f164()
{
	...
	level thread scene::add_scene_func("p7_fxanim_zm_island_cage_trap_low_up_bundle", &hatch_reopen, "play");
...
function function_1c683357()
{
	...
	ai_carrier = array::random(a_ai_carriers);
