...
function function_a39c9866(localclientnum, var_fe2fb4b9, var_f471914b, n_character_index)
{
	...
	switch(var_fe2fb4b9)
	{
		...
		case 2:
		{
			...
			s_keeper.var_4cf62d2c show();
			s_keeper.var_b0ff8d18 = playfxontag(localclientnum, level._effect["ee_totem_to_ghost"], s_keeper.var_4cf62d2c, "j_head");
		...
		case 3:
		{
			...
			s_keeper.var_6b0fc6a1 = playfxontag(localclientnum, level._effect["keeper_spawn"], s_keeper.var_4cf62d2c, "tag_origin");
			s_keeper.model playsound(0, "evt_keeper_portal_end");
			s_keeper.var_4cf62d2c playsound(0, "evt_keeper_portal_end");
			wait(1);
			s_keeper.model hide();
			s_keeper.var_4cf62d2c hide();
...
function function_e1e53e16(localclientnum, n_character_index)
{
	...
	if(!isdefined(s_keeper.var_4cf62d2c))
	{
		var_f4fc4f28 = struct::get("keeper_resurrection_totem_" + (n_character_index - 1), "targetname");
		s_keeper.var_4cf62d2c = spawn(localclientnum, var_f4fc4f28.origin, "script_model");
		s_keeper.var_4cf62d2c.angles = var_f4fc4f28.angles;
		s_keeper.var_4cf62d2c setmodel("t7_zm_zod_keepers_totem");
		s_keeper.var_4cf62d2c hide();
	}
	return s_keeper;
}
