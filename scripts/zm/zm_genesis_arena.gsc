...
class class_d90687be 
{
	...
	*/
	...
	{
		level notify("arena_margwa_spawning");
		level endon("arena_margwa_spawning");
...
function function_e883aed0()
{
	...
	while(true)
	{
		...
		self.var_c08f97f = n_dist > 16384 || (!(isdefined(var_be0f0621.b_protect) && var_be0f0621.b_protect));
		if(self.var_c08f97f)
		{
...
function function_73ff31ff()
{
	...
	for(x = 1; x < 4; x++)
	{
		...
		{
			var_495730fe = function_7d8f4dd0(x, y);
			if(!(isdefined(var_495730fe.b_protect) && var_495730fe.b_protect))
			{
...
{
	if(isdefined(s_fence.b_raised) && s_fence.b_raised)
	{
		return;
	}
	s_fence.b_raised = 1;
...
/*
	...
	Flags: Linked
*/
function function_320bc09(n_max, n_exclude)
{
	a_numbers = [];
	for(i = 0; i < n_max; i++)
	{
...
function function_b1b0d2b0()
{
	...
	var_78a22131 notify("shadowman_spawned");
