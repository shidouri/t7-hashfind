...
/*
	...
	Flags: Linked
*/
function updatepersonalthreatbias_attackerlockedontome(var_9f84050f, bias_duration, var_9c5ca2c, var_cee3c9e9)
{
	function_c8b0c8c2(self.locked_on, var_9f84050f, bias_duration, var_9c5ca2c, var_cee3c9e9);
}
...
/*
	...
	Flags: Linked
*/
function updatepersonalthreatbias_attackerlockingontome(var_9f84050f, bias_duration, var_9c5ca2c, var_cee3c9e9)
{
	function_c8b0c8c2(self.locking_on, var_9f84050f, bias_duration, var_9c5ca2c, var_cee3c9e9);
}
...
/*
	...
	Flags: Linked
*/
function function_c8b0c8c2(client_flags, var_9f84050f, bias_duration, var_9c5ca2c = 1, var_cee3c9e9 = 1)
{
	/#
	...
	for(i = 0; remaining_flags_to_process && i < level.players.size; i++)
	{
		...
		if(isdefined(attacker))
		{
			...
			{
				self setpersonalthreatbias(attacker, int(var_9f84050f), bias_duration);
				if(var_9c5ca2c)
				{
...
/*
	...
	Flags: None
*/
function updatepersonalthreatbias_bots(var_9f84050f, bias_duration)
{
	/#
		foreach(player in level.players)
		{
			...
			{
				self setpersonalthreatbias(player, int(var_9f84050f), bias_duration);
			}
		}
	#/
}
