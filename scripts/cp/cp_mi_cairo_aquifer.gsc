...
function skipto_setup()
{
	...
	skipto::add_saved("intro_dogfight", &aquifer_obj::skipto_intro_dogfight_init, "Destroy Bogey spawnvtol", &aquifer_obj::skipto_intro_dogfight_done);
	...
	skipto::add_saved("destroy_defenses_mid", &aquifer_obj::skipto_defenses_init_mid, "Destroy Remaining AA spawnvtol", &aquifer_obj::skipto_defenses_mid_done);
	skipto::add_saved("hack_terminal_right", &aquifer_obj::skipto_hack_right_init, "Hack Right Defend checkkayneexist", &aquifer_obj::skipto_hack_right_done);
	skipto::add("water_room", &aquifer_obj::skipto_water_room_init, "Searching checkenteredwater", &aquifer_obj::skipto_water_room_done);
	skipto::add_saved("water_room_exit", &aquifer_obj::skipto_water_room_exit_init, "Exit Water", &aquifer_obj::skipto_water_room_exit_done);
	skipto::add_saved("post_water_room_dogfight", &aquifer_obj::skipto_post_water_room_dogfight_init, "Destroy Bogey", &aquifer_obj::skipto_post_water_room_dogfight_done);
	...
	skipto::add_saved("sniper_boss_intro", &aquifer_obj::skipto_boss_intro_init, "Hyperion Battle Intro", &aquifer_obj::skipto_boss_intro_done);
	...
	skipto::add("run_out", &aquifer_obj::skipto_runout_init, "Flee From Aquifer", &aquifer_obj::skipto_runout_done);
