...
function function_549c28ac(var_6a173bd1)
{
	...
	for(i = 0; i < numweapons; i++)
	{
		...
		var_279890e8.minattachments = int(tablelookupcolumnforrow(var_6a173bd1, i, 1));
...
function function_53200e4d(var_1010f96a)
{
	...
	numattachments = 0;
	if(var_279890e8.minattachments >= 0 && var_279890e8.maxattachments > 0)
	{
		numattachments = randomintrange(var_279890e8.minattachments, var_279890e8.maxattachments);
	}
	if(numattachments > 0)
	{
