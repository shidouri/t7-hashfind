...
function function_70176ad6()
{
	...
	{
		self waittill("gadget_denied_activation", n_slot, n_reason);
		if(n_reason == 1)
		{
			self.var_98bf72c3++;
...
/*
	...
	Flags: Linked
*/
function function_bccc2e65(str_aigroup, ai_limit, str_node, goal_radius)
{
	spawner::waittill_ai_group_ai_count("aig_water_treatment", ai_limit);
